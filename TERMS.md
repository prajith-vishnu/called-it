...
5. **Acceptable use.** You only pick from preset options and choose a preset username — there is no user-generated free text. Don't attempt to abuse, attack, or reverse the service.
6. **Data.** Your data is handled as described in the [Privacy Policy](PRIVACY.md): nothing personal is collected; your progress stays on your device.
7. **No warranty.** The app is provided "as is," without warranties. It may change or go offline at any time.
8. **Limitation.** To the extent allowed by law, the project owner isn't liable for damages arising from use of this prototype.
